...
/**
 * Redesigned car page (route: /cars2/[slug]), built to the "Carmarketplace UI
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    // Out of the index while it runs alongside the live car page.
  ...
  return (
    <div className="ah-site mp-car2">
      ...
      <div className="container container--wide mp2-car__back">
        <Link href="/cars2" className="mp2-backlink">
          &larr; All cars
        </Link>
      </div>
            ...
            {sold ? (
              ...
              <>
                ...
                <p className="mp2-rail__finance">
                  ...
                  on finance &middot;{" "}
                  <Link href={`/finance2?price=${car.price}`}>estimate yours</Link>
                </p>
              </>
            )}
          </div>
        ...
        <section className="mp2-also">
          <div className="container container--wide">
            ...
            <div className="mp2-also__grid">
              {others.map((c) => (
                <ListingCard key={c.id} car={c} basePath="/cars2" />
              ))}
            </div>
          </div>
        </section>
