...
/**
 * The dealer dashboard (route: /admin), built to the "Carmarketplace
 * UI mockups" artifact, frame 1l.
 *
 * The same queries the previous dashboard ran, plus the inventory panel the
 * artifact adds beside the activity feed — read through the admin's own Supabase
