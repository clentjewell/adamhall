...
export const metadata: Metadata = {
  ...
  // Out of the index while it runs alongside the live FAQ page.
  robots: { index: false, follow: false },
};

/**
 * Redesigned FAQ (route: /faq2), built to the "Carmarketplace UI mockups"
 * artifact, frame 1j.
 *
      ...
      <div className="container container--wide mp2-faq">
        ...
        <aside className="mp2-faq__aside">
          <div className="mp2-faq__card">
            ...
            <Link href="/contact-us2" className="btn btn--outline-green mp2-faq__cta">
              Send a message
            </Link>
          </div>
        </aside>
