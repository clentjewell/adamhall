...
export const metadata: Metadata = {
  ...
  // Out of the index while it runs alongside the live contact page.
  robots: { index: false, follow: false },
};

/**
 * Redesigned contact page (route: /contact-us2), built to the "Carmarketplace
      ...
      <div className="container container--wide mp2-contact">
        <div className="mp2-contact__intro">
          ...
          <p className="mp2-contact__more">
            ...
            <Link href="/faq2">Read the common questions</Link> &mdash; most
