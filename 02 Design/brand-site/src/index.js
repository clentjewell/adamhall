// Adam Hall — Buy My Car · Brand Identity
// Password gate + static assets. Mirrors the Beyond the Clinic brand worker.

const COOKIE_NAME = "amh_brand_session";
...
<title>Adam Hall &middot; Buy My Car — Brand Identity</title>
...
<style>
  *{box-sizing:border-box}
  body{margin:0;min-height:100vh;display:grid;place-items:center;padding:24px;color:#FAF8F4;
    ...
    background:radial-gradient(1200px 700px at 20% 0%,rgba(194,159,216,.28),transparent 60%),
      linear-gradient(150deg,#00251f 0%,#004438 55%,#00251f 100%)}
  .card{width:100%;max-width:392px;text-align:center}
  .logo{height:64px;margin:0 0 22px;filter:invert(1)}
  h1{font-weight:600;margin:0 0 6px;font-size:28px;letter-spacing:-0.02em}
  p.sub{opacity:.82;margin:0 0 22px;font-weight:300}
  p.err{background:rgba(194,159,216,.22);border:1px solid rgba(194,159,216,.55);
  ...
  input:focus{outline:none;border-color:#c29fd8;background:rgba(250,248,244,.16)}
  button{padding:13px 14px;border-radius:6px;border:0;background:#c29fd8;color:#00251f;
...
<body>
  <main class="card">
    ...
    <p class="sub">This brand pack is private. Enter the password to continue.</p>
    ${error}
